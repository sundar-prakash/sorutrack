  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case _Loading() when loading != null:
        return loading();
      case _Loaded() when loaded != null:
        return loaded(_that.data, _that.selectedDate, _that.isRefreshing);
      case _Error() when error != null:
...
class _Loaded implements DashboardState {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, data, selectedDate, isRefreshing);
...
abstract mixin class _$LoadedCopyWith<$Res>
  ...
  @useResult
  $Res call({DashboardData data, DateTime selectedDate, bool isRefreshing});
}
