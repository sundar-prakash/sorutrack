        ...
        children: [
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  trailing: Text('${item['calories']} kcal', style: const TextStyle(fontWeight: FontWeight.bold)),
                );
              },
            ),
          ),
          if (previewData.length > 10)
            Padding(
              ...
              child: Text('+ ${previewData.length - 10} more items...', style: TextStyle(color: Colors.grey[600], fontStyle: FontStyle.italic)),
            ),
          Container(
            padding: const EdgeInsets.all(16),
            ...
            child: Column(
              children: [
                const Row(
                  ...
                  children: [
                    Text('Conflict Resolution:', style: TextStyle(fontWeight: FontWeight.bold)),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: const Text('Proceed with Import', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                  ),
                ),
              ],
            ),
