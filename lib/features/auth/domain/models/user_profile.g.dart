...
_UserProfile _$UserProfileFromJson(Map<String, dynamic> json) => _UserProfile(
  ...
  dietaryPreference: $enumDecode(
    _$DietaryPreferenceEnumMap,
  ...
  cuisines:
      ...
      const [],
  mealReminderMorning: DateTime.parse(json['mealReminderMorning'] as String),
  mealReminderAfternoon: DateTime.parse(
    json['mealReminderAfternoon'] as String,
  ),
  mealReminderEvening: DateTime.parse(json['mealReminderEvening'] as String),
  waterReminderIntervalMinutes: (json['waterReminderIntervalMinutes'] as num)
      .toInt(),
...
Map<String, dynamic> _$UserProfileToJson(
  ...
  'dietaryPreference': _$DietaryPreferenceEnumMap[instance.dietaryPreference]!,
