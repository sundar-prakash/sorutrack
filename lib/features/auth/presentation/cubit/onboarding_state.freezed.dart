...
mixin _$OnboardingState {
 ...
 int get currentStep; String get name; DateTime? get dateOfBirth; Gender get gender; double get height; HeightUnit get heightUnit; double get weight; WeightUnit get weightUnit; ActivityLevel get activityLevel; GoalType get goal; double get targetWeight; double get weeklyGoal; DateTime? get targetDate; DietaryPreference get dietaryPreference; List<String> get allergies; List<String> get cuisines; DateTime? get mealReminderMorning; DateTime? get mealReminderAfternoon; DateTime? get mealReminderEvening; int get waterReminderIntervalMinutes; String get geminiApiKey; bool get isSubmitting; String? get error;
...
@useResult
$Res call({
 int currentStep, String name, DateTime? dateOfBirth, Gender gender, double height, HeightUnit heightUnit, double weight, WeightUnit weightUnit, ActivityLevel activityLevel, GoalType goal, double targetWeight, double weeklyGoal, DateTime? targetDate, DietaryPreference dietaryPreference, List<String> allergies, List<String> cuisines, DateTime? mealReminderMorning, DateTime? mealReminderAfternoon, DateTime? mealReminderEvening, int waterReminderIntervalMinutes, String geminiApiKey, bool isSubmitting, String? error
});
...
as List<String>,mealReminderMorning: freezed == mealReminderMorning ? _self.mealReminderMorning : mealReminderMorning // ignore: cast_nullable_to_non_nullable
as DateTime?,mealReminderAfternoon: freezed == mealReminderAfternoon ? _self.mealReminderAfternoon : mealReminderAfternoon // ignore: cast_nullable_to_non_nullable
as DateTime?,mealReminderEvening: freezed == mealReminderEvening ? _self.mealReminderEvening : mealReminderEvening // ignore: cast_nullable_to_non_nullable
...
as int,geminiApiKey: null == geminiApiKey ? _self.geminiApiKey : geminiApiKey // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int currentStep,  String name,  DateTime? dateOfBirth,  Gender gender,  double height,  HeightUnit heightUnit,  double weight,  WeightUnit weightUnit,  ActivityLevel activityLevel,  GoalType goal,  double targetWeight,  double weeklyGoal,  DateTime? targetDate,  DietaryPreference dietaryPreference,  List<String> allergies,  List<String> cuisines,  DateTime? mealReminderMorning,  DateTime? mealReminderAfternoon,  DateTime? mealReminderEvening,  int waterReminderIntervalMinutes,  String geminiApiKey,  bool isSubmitting,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OnboardingState() when $default != null:
return $default(_that.currentStep,_that.name,_that.dateOfBirth,_that.gender,_that.height,_that.heightUnit,_that.weight,_that.weightUnit,_that.activityLevel,_that.goal,_that.targetWeight,_that.weeklyGoal,_that.targetDate,_that.dietaryPreference,_that.allergies,_that.cuisines,_that.mealReminderMorning,_that.mealReminderAfternoon,_that.mealReminderEvening,_that.waterReminderIntervalMinutes,_that.geminiApiKey,_that.isSubmitting,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int currentStep,  String name,  DateTime? dateOfBirth,  Gender gender,  double height,  HeightUnit heightUnit,  double weight,  WeightUnit weightUnit,  ActivityLevel activityLevel,  GoalType goal,  double targetWeight,  double weeklyGoal,  DateTime? targetDate,  DietaryPreference dietaryPreference,  List<String> allergies,  List<String> cuisines,  DateTime? mealReminderMorning,  DateTime? mealReminderAfternoon,  DateTime? mealReminderEvening,  int waterReminderIntervalMinutes,  String geminiApiKey,  bool isSubmitting,  String? error)  $default,) {final _that = this;
switch (_that) {
case _OnboardingState():
return $default(_that.currentStep,_that.name,_that.dateOfBirth,_that.gender,_that.height,_that.heightUnit,_that.weight,_that.weightUnit,_that.activityLevel,_that.goal,_that.targetWeight,_that.weeklyGoal,_that.targetDate,_that.dietaryPreference,_that.allergies,_that.cuisines,_that.mealReminderMorning,_that.mealReminderAfternoon,_that.mealReminderEvening,_that.waterReminderIntervalMinutes,_that.geminiApiKey,_that.isSubmitting,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int currentStep,  String name,  DateTime? dateOfBirth,  Gender gender,  double height,  HeightUnit heightUnit,  double weight,  WeightUnit weightUnit,  ActivityLevel activityLevel,  GoalType goal,  double targetWeight,  double weeklyGoal,  DateTime? targetDate,  DietaryPreference dietaryPreference,  List<String> allergies,  List<String> cuisines,  DateTime? mealReminderMorning,  DateTime? mealReminderAfternoon,  DateTime? mealReminderEvening,  int waterReminderIntervalMinutes,  String geminiApiKey,  bool isSubmitting,  String? error)?  $default,) {final _that = this;
switch (_that) {
case _OnboardingState() when $default != null:
return $default(_that.currentStep,_that.name,_that.dateOfBirth,_that.gender,_that.height,_that.heightUnit,_that.weight,_that.weightUnit,_that.activityLevel,_that.goal,_that.targetWeight,_that.weeklyGoal,_that.targetDate,_that.dietaryPreference,_that.allergies,_that.cuisines,_that.mealReminderMorning,_that.mealReminderAfternoon,_that.mealReminderEvening,_that.waterReminderIntervalMinutes,_that.geminiApiKey,_that.isSubmitting,_that.error);case _:
  return null;
...
class _OnboardingState implements OnboardingState {
  const _OnboardingState({this.currentStep = 0, this.name = '', this.dateOfBirth, this.gender = Gender.male, this.height = 170, this.heightUnit = HeightUnit.cm, this.weight = 70, this.weightUnit = WeightUnit.kg, this.activityLevel = ActivityLevel.sedentary, this.goal = GoalType.maintain, this.targetWeight = 70, this.weeklyGoal = 0.5, this.targetDate, this.dietaryPreference = DietaryPreference.nonVeg, final  List<String> allergies = const [], final  List<String> cuisines = const [], this.mealReminderMorning, this.mealReminderAfternoon, this.mealReminderEvening, this.waterReminderIntervalMinutes = 60, this.geminiApiKey = '', this.isSubmitting = false, this.error}): _allergies = allergies,_cuisines = cuisines;
...
@override@JsonKey() final  WeightUnit weightUnit;
@override@JsonKey() final  ActivityLevel activityLevel;
@override@JsonKey() final  GoalType goal;
@override@JsonKey() final  double targetWeight;
@override@JsonKey() final  double weeklyGoal;
...
@override@JsonKey() final  int waterReminderIntervalMinutes;
